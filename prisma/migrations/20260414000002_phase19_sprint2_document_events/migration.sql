...
CREATE INDEX "document_event_orgId_docType_documentId_eventAt_idx"
    ON "document_event"("orgId", "docType", "documentId", "eventAt");

-- Org-wide event type queries (analytics / admin)
CREATE INDEX "document_event_orgId_eventType_eventAt_idx"
    ON "document_event"("orgId", "eventType", "eventAt");

-- Org-wide doc-type event queries
CREATE INDEX "document_event_orgId_docType_eventAt_idx"
