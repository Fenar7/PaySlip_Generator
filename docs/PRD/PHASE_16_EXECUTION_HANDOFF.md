# Phase 16 Execution Handoff
## Exact Prompt Pack for GPT-5.4 High

**Purpose:** This file is the operator-facing execution sheet for the Phase 16 remediation package.  
**How to use it:** Pick the workstream you want to run, copy the corresponding prompt, and give it to your GPT-5.4 High engineering agent with repo access.

## Read This First

Do **not** ask one agent to execute all workstreams in one branch.

Use this order:

1. `WS-A` — Access control and approval hardening
2. `WS-B` — Books product-contract completion
3. `WS-C` — Reconciliation and finance correctness hardening
4. `WS-D` — Deferred roadmap stubs

## Core Reference Files

These are the common files the execution agents should read before implementation:

- [PHASE_16_AUDIT_REPORT.md](/Users/mac/Fenar/Zenxvio/product-works/payslip-generator/docs/PRD/PHASE_16_AUDIT_REPORT.md)
- [PHASE_16_TRACEABILITY_MATRIX.md](/Users/mac/Fenar/Zenxvio/product-works/payslip-generator/docs/PRD/PHASE_16_TRACEABILITY_MATRIX.md)
- [PHASE_16_PRD.md](/Users/mac/Fenar/Zenxvio/product-works/payslip-generator/docs/PRD/PHASE_16_PRD.md)

## Master Controller Prompt

Use this only for the lead/orchestrator agent.
...
**PRD location:** [PHASE_16_REMEDIATION_WS_A_ACCESS_APPROVALS_PRD.md](/Users/mac/Fenar/Zenxvio/product-works/payslip-generator/docs/PRD/PHASE_16_REMEDIATION_WS_A_ACCESS_APPROVALS_PRD.md)

**Branch to create:** `feature/phase-16-remediation-a-access-approvals`

**What this workstream is for:**

- fix approval authority so org membership alone is insufficient
- align Books access with the intended role model
...
**PRD location:** [PHASE_16_REMEDIATION_WS_B_BOOKS_CONTRACT_PRD.md](/Users/mac/Fenar/Zenxvio/product-works/payslip-generator/docs/PRD/PHASE_16_REMEDIATION_WS_B_BOOKS_CONTRACT_PRD.md)

**Branch to create:** `feature/phase-16-remediation-b-books-contract`

**What this workstream is for:**

- complete the Books settings contract
- add journal attachment support
- resolve the reopen/control-path contract gaps
...
**PRD location:** [PHASE_16_REMEDIATION_WS_C_RECONCILIATION_CORRECTNESS_PRD.md](/Users/mac/Fenar/Zenxvio/product-works/payslip-generator/docs/PRD/PHASE_16_REMEDIATION_WS_C_RECONCILIATION_CORRECTNESS_PRD.md)

**Branch to create:** `feature/phase-16-remediation-c-reconciliation-correctness`

**What this workstream is for:**

- replace hardcoded import/reconciliation guardrails with config-backed tunables
- harden reconciliation edge cases
- strengthen finance correctness coverage
...
**PRD location:** [PHASE_16_REMEDIATION_WS_D_DEFERRED_STUBS_PRD.md](/Users/mac/Fenar/Zenxvio/product-works/payslip-generator/docs/PRD/PHASE_16_REMEDIATION_WS_D_DEFERRED_STUBS_PRD.md)

**Branch to create:** `feature/phase-16-remediation-d-deferred-phase16-stubs`

**What this workstream is for:**

- handle earlier roadmap items that were explicitly deferred into Phase 16
- either implement them now or formally defer them out
...
### WS-D resolution note

- Marketplace payout automation was moved out of active Phase 16 remediation and requires a dedicated follow-on PRD.
- GST automation in WS-D is limited to explicit GSTR-1 JSON export support.
- GST portal/API submission remains deferred out of Phase 16.

---

## Recommended Minimal Start

If you want to start immediately with the most important branch, use only this:

1. Read [PHASE_16_AUDIT_REPORT.md](/Users/mac/Fenar/Zenxvio/product-works/payslip-generator/docs/PRD/PHASE_16_AUDIT_REPORT.md)
2. Read [PHASE_16_REMEDIATION_WS_A_ACCESS_APPROVALS_PRD.md](/Users/mac/Fenar/Zenxvio/product-works/payslip-generator/docs/PRD/PHASE_16_REMEDIATION_WS_A_ACCESS_APPROVALS_PRD.md)
3. Paste the `WS-A Prompt`

## Recommended Execution Pattern

- Use one GPT-5.4 High orchestrator with the Master Controller Prompt
- Use one execution agent per workstream branch
- Do not start `WS-B` or `WS-C` until `WS-A` is merged or at least stable enough that the role/approval contract is settled
- Run `WS-D` last
