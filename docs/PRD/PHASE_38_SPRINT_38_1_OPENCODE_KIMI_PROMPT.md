# Phase 38 Sprint 38.1 OpenCode Kimi Prompt
...
You are starting a fresh execution chat for PDF Studio Phase 38 Sprint 38.1 in this repository.

Current repo context:
- Repo: /Users/mac/Fenar/Zenxvio/product-works/payslip-generator
- Current local branch: pdf-studio-continuation
- Current local HEAD: dc9e2af
- Local pdf-studio-continuation is aligned with origin/pdf-studio-continuation
- Phase 37 is complete and already merged into pdf-studio-continuation
- This is the first sprint of Phase 38
- Local untracked prompt/doc noise may exist, such as:
  - docs/PRD/PHASE_38_SPRINT_38_1_KIMI_EXECUTION_PROMPT.md
  Ignore unrelated prompt/doc artifacts unless the sprint explicitly requires touching them
...
Sprint 38.1 implementation surfaces:
...
Sprint 38.1 acceptance criteria:
...
Mandatory workflow and branching rules:
- Do not work on master
- Do not work directly on pdf-studio-continuation
- Create a new phase branch from pdf-studio-continuation
- Create the sprint branch from the current head of that phase branch
- Sprint PR must target the phase branch
...
Do not touch unrelated noise such as:
- docs/opencode/
- docs/codex/
- docs/copilot/
- unrelated local prompt artifacts unless needed for the sprint
