...
export async function POST(request: Request) {
  ...
  try {
    ...
    const bankAccountId = body?.bankAccountId ?? url.searchParams.get("bankAccountId") ?? undefined;
    const importId = body?.importId ?? url.searchParams.get("importId") ?? undefined;
