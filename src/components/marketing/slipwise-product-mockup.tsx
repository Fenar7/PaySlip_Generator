...
const statCards = [
  { label: "Salary run", value: "₹45,500", tone: "bg-[var(--surface-soft)]" },
...
export function SlipwiseProductMockup() {
  return (
    <div className="relative mx-auto w-full max-w-[39rem]">
      <div className="absolute -left-10 top-12 h-28 w-28 rounded-full bg-[rgba(220,38,38,0.05)] blur-[82px]" />
      <div className="absolute -right-8 top-8 h-36 w-36 rounded-full bg-[rgba(87,87,96,0.04)] blur-[96px]" />

      <div
        data-animate="mockup-shell"
        className="relative overflow-hidden rounded-2xl border border-[var(--border-strong)] bg-white p-3 shadow-[var(--shadow-card)]"
      >
        <div className="overflow-hidden rounded-xl border border-[var(--border-soft)] bg-[var(--background)] p-4 text-[var(--foreground)]">
          <div
            data-animate="mockup-pane"
            className="flex flex-col gap-4 rounded-xl border border-[var(--border-soft)] bg-white px-4 py-4 shadow-[var(--shadow-card)]"
          >
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div className="flex items-center gap-3">
                <span className="inline-flex h-10 w-10 items-center justify-center rounded-lg border border-[var(--border-soft)] bg-[var(--surface-soft)] text-sm font-semibold text-[var(--accent)]">
                  S
                </span>
                <div>
            ...
            <div className="grid gap-4 lg:grid-cols-[11rem_minmax(0,1fr)]">
                ...
                <div className="mt-3 space-y-2.5">
                  {railItems.map((item) => (
                    <div
                      ...
                      className="rounded-lg border border-[var(--border-soft)] bg-white px-3 py-3"
                    >
              ...
              >
                ...
                <div className="mt-4 rounded-xl border border-[var(--border-soft)] bg-white px-4 py-4 shadow-[var(--shadow-soft)]">
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="h-10 w-10 rounded-lg border border-[var(--border-soft)] bg-[var(--surface-soft)]" />
                  </div>
            ...
            <section className="grid gap-3 md:grid-cols-3">
              {statCards.map((card) => (
                <div
                  ...
                  className={`rounded-xl border border-[var(--border-soft)] px-4 py-3 ${card.tone}`}
                >
