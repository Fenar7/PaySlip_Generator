...
> = {
  ...
  "pdf-to-word": {
    ...
    title: "PDF to Word",
    description:
      "Queue a server-side PDF to DOCX conversion with polling, deterministic naming, and explicit layout-fidelity limits.",
    icon: "📘",
    category: "convert-export",
  ...
  "pdf-to-excel": {
    ...
    title: "PDF to Excel",
    description:
      "Queue a server-side PDF to XLSX conversion with worksheet-per-page output and explicit table-fidelity messaging.",
    icon: "📗",
    category: "convert-export",
  ...
  "pdf-to-ppt": {
    ...
    title: "PDF to PPT",
    description:
      "Queue a server-side PDF to PPTX conversion with one slide per source page and explicit fidelity disclaimers.",
    icon: "📙",
    category: "convert-export",
  ...
  "word-to-pdf": {
    ...
    title: "Word to PDF",
    description:
      "Queue a server-side DOCX to PDF conversion with print-layout options and explicit font/rendering policy copy.",
    icon: "📄",
    category: "convert-export",
  ...
  "html-to-pdf": {
    ...
    title: "HTML to PDF",
    description:
      "Queue a server-side HTML to PDF conversion from a file upload or URL with page size, margin, and print CSS controls.",
    icon: "🌐",
    category: "convert-export",
